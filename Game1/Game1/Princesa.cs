...
namespace Game1
{
    class Princesa: AnimacaoSprite
    {
        ...
        public Princesa(string _nome, int _vida, int _posX, int _posY, int _nivelDano, int linhasSprite, int colunasSprite, int _AndarDireita, int _AndarEsquerda, int _AtacarDireita, int _AtacarEsquerda, int velocidade = 100, int _delay = 200, int _frequenciaDano = 3000, int _distanciaPerseguir = 1000)
        {
            nome = _nome;
            vida = _vida;
